...
*   **[requirements_master.md](docs/requirements/requirements_master.md)**
    ...
    *   **[new_relic_monitoring_requirements.md](docs/requirements/new_relic_monitoring_requirements.md)**: New Relic 統合監視要件定義書 (APM・外形監視・Cloud Run連携) (Issue #471)
...
*   **[new_relic_monitoring_design.md](docs/basic_design/new_relic_monitoring_design.md)**: New Relic 統合監視基本設計書 (APM・Synthetics・Cloud Run連携) (Issue #471)
...
- **[New Relic 統合監視内部詳細設計書](docs/internal_design/new_relic_monitoring_internal_design.md)** - New Relic APM初期化・Synthetics監視自動構成・Secret Manager連携詳細設計 (Issue #471)
