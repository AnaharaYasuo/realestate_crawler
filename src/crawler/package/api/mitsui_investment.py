...
from package.api.api import ParseDetailPageAsyncBase, ParseMiddlePageAsyncBase, \
    ...
    API_KEY_MITSUI_INVEST_KODATE_AREA_GCP, API_KEY_MITSUI_INVEST_KODATE_LIST_GCP, API_KEY_MITSUI_INVEST_KODATE_DETAIL_GCP, \
    ...
    API_KEY_MITSUI_INVEST_APARTMENT_AREA_GCP, API_KEY_MITSUI_INVEST_APARTMENT_LIST_GCP, API_KEY_MITSUI_INVEST_APARTMENT_DETAIL_GCP
