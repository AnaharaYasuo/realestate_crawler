...
from package.api.api import API_KEY_MITSUI_MANSION_DETAIL_GCP, API_KEY_MITSUI_MANSION_DETAIL, API_KEY_MITSUI_MANSION_AREA_GCP, API_KEY_MITSUI_MANSION_AREA, API_KEY_MITSUI_MANSION_LIST_GCP, API_KEY_MITSUI_MANSION_LIST, API_KEY_MITSUI_MANSION_START
from package.api.api import API_KEY_MITSUI_TOCHI_AREA, API_KEY_MITSUI_TOCHI_AREA_GCP, API_KEY_MITSUI_TOCHI_DETAIL, API_KEY_MITSUI_TOCHI_DETAIL_GCP, API_KEY_MITSUI_TOCHI_LIST, API_KEY_MITSUI_TOCHI_LIST_GCP, API_KEY_MITSUI_TOCHI_START
from package.api.api import API_KEY_MITSUI_KODATE_AREA, API_KEY_MITSUI_KODATE_AREA_GCP, API_KEY_MITSUI_KODATE_DETAIL, API_KEY_MITSUI_KODATE_DETAIL_GCP, API_KEY_MITSUI_KODATE_LIST, API_KEY_MITSUI_KODATE_LIST_GCP, API_KEY_MITSUI_KODATE_START
...
# Mansion
ApiRegistry.register(API_KEY_MITSUI_MANSION_START, ParseMitsuiMansionStartAsync)
ApiRegistry.register(API_KEY_MITSUI_MANSION_AREA, ParseMitsuiMansionAreaFuncAsync)
ApiRegistry.register(API_KEY_MITSUI_MANSION_LIST, ParseMitsuiMansionListFuncAsync)
ApiRegistry.register(API_KEY_MITSUI_MANSION_DETAIL, ParseMitsuiMansionDetailFuncAsync)

# Tochi
ApiRegistry.register(API_KEY_MITSUI_TOCHI_START, ParseMitsuiTochiStartAsync)
ApiRegistry.register(API_KEY_MITSUI_TOCHI_AREA, ParseMitsuiTochiAreaFuncAsync)
ApiRegistry.register(API_KEY_MITSUI_TOCHI_LIST, ParseMitsuiTochiListFuncAsync)
ApiRegistry.register(API_KEY_MITSUI_TOCHI_DETAIL, ParseMitsuiTochiDetailFuncAsync)

# Kodate
ApiRegistry.register(API_KEY_MITSUI_KODATE_START, ParseMitsuiKodateStartAsync)
ApiRegistry.register(API_KEY_MITSUI_KODATE_AREA, ParseMitsuiKodateAreaFuncAsync)
ApiRegistry.register(API_KEY_MITSUI_KODATE_LIST, ParseMitsuiKodateListFuncAsync)
ApiRegistry.register(API_KEY_MITSUI_KODATE_DETAIL, ParseMitsuiKodateDetailFuncAsync)
