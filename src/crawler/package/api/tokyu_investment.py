...
from package.api.api import ApiAsyncProcBase, ParseDetailPageAsyncBase, ParseMiddlePageAsyncBase, \
    ...
    API_KEY_TOKYU_INVEST_APARTMENT_LIST_GCP, API_KEY_TOKYU_INVEST_APARTMENT_DETAIL_GCP, \
    API_KEY_TOKYU_INVEST_KODATE_START, API_KEY_TOKYU_INVEST_KODATE_LIST, API_KEY_TOKYU_INVEST_KODATE_DETAIL, \
    API_KEY_TOKYU_INVEST_KODATE_LIST_GCP, API_KEY_TOKYU_INVEST_KODATE_DETAIL_GCP

from package.parser.tokyuParser import TokyuInvestmentApartmentParser, TokyuInvestmentKodateParser
from package.api.registry import ApiRegistry

DEFAULT_PARALLEL_LIMIT = 1
DEFAULT_PARARELL_LIMIT = DEFAULT_PARALLEL_LIMIT  # legacy alias (cloud path)
