...
class SumirinMansion(SumirinModel):
    ...
    class Meta(SumirinModel.Meta):
        db_table = "sumirin_mansion"

class SumirinTochi(SumirinModel):
...
class SumirinInvestment(SumirinModel):
    ...
    kenpeiStr = models.TextField(blank=True)
    kenpei = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    yousekiStr = models.TextField(blank=True)
    youseki = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)

    setsudou = models.TextField(blank=True)
    chimoku = models.TextField(blank=True)
    youtoChiiki = models.TextField(blank=True)

    propertyType = models.CharField(max_length=50, blank=True)

    class Meta(SumirinModel.Meta):
        db_table = "sumirin_investment"

class SumirinKodate(SumirinModel):
    madori = models.TextField(blank=True)
    tochiMensekiStr = models.TextField(blank=True)
    tochiMenseki = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    tatemonoMensekiStr = models.TextField(blank=True)
