...
class RearieModel(PropertyBaseModel, TransportationMixin):
...
class RearieMansion(RearieModel):
    ...
    class Meta(RearieModel.Meta):
        db_table = "rearie_mansion"

class RearieTochi(RearieModel):
    ...
    class Meta(RearieModel.Meta):
        db_table = "rearie_tochi"

class RearieKodate(RearieModel):
    tochiMensekiStr = models.TextField(blank=True, null=True)
    tochiMenseki = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
