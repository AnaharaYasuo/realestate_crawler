...
class KeikyuModel(PropertyBaseModel, TransportationMixin):
...
class KeikyuMansion(KeikyuModel):
    ...
    class Meta(KeikyuModel.Meta):
        db_table = "keikyu_mansion"

class KeikyuKodate(KeikyuModel):
    ...
    class Meta(KeikyuModel.Meta):
        db_table = "keikyu_kodate"

class KeikyuTochi(KeikyuModel):
    tochiMensekiStr = models.TextField(blank=True, default="")
    tochiMenseki = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
