...
class SmtrcModel(PropertyBaseModel, TransportationMixin):
...
class SmtrcMansion(SmtrcModel):
    ...
    class Meta(SmtrcModel.Meta):
        db_table = "smtrc_mansion"
