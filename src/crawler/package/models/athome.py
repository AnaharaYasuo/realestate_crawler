...
class AthomeModel(PropertyBaseModel, TransportationMixin):
...
class AthomeInvestmentApartment(AthomeModel):
    # 投資用固有項目
    ...
    class Meta(AthomeModel.Meta):
        db_table = "athome_investment_apartment"

class AthomeMansion(AthomeModel):
    ...
    class Meta(AthomeModel.Meta):
        db_table = "athome_mansion"

class AthomeKodate(AthomeModel):
    ...
    class Meta(AthomeModel.Meta):
        db_table = "athome_kodate"


class AthomeTochi(AthomeModel):
    # 土地面積
