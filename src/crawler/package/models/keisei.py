...
class KeiseiModel(PropertyBaseModel, TransportationMixin):
...
class KeiseiMansion(KeiseiModel):
    ...
    class Meta(KeiseiModel.Meta):
        db_table = "keisei_mansion"

class KeiseiKodate(KeiseiModel):
    ...
    class Meta(KeiseiModel.Meta):
        db_table = "keisei_kodate"

class KeiseiTochi(KeiseiModel):
    tochiMensekiStr = models.TextField(blank=True, null=True)
    tochiMenseki = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
