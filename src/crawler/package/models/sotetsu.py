...
class SotetsuModel(PropertyBaseModel, TransportationMixin):
...
class SotetsuMansion(SotetsuModel):
    ...
    class Meta(SotetsuModel.Meta):
        db_table = "sotetsu_mansion"

class SotetsuKodate(SotetsuModel):
    ...
    class Meta(SotetsuModel.Meta):
        db_table = "sotetsu_kodate"

class SotetsuTochi(SotetsuModel):
    tochiMensekiStr = models.TextField(blank=True, default="")
    tochiMenseki = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
