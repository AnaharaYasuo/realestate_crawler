...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('package', '0032_daiwakodate_daiwamansion_daiwatochi_odakyukodate_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='MizuhoInvestment',
            fields=[
