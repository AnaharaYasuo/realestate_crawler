...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('package', '0033_mizuhoinvestment_odakyuinvestment_smtrcinvestment_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='SumirinInvestment',
            fields=[
                ...
                ('grossYield', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ...
                ('kenpei', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('yousekiStr', models.TextField(blank=True)),
                ('youseki', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('setsudou', models.TextField(blank=True)),
                ('chimoku', models.TextField(blank=True)),
                ('youtoChiiki', models.TextField(blank=True)),
                ('propertyType', models.CharField(blank=True, max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tochiMensekiStr', models.TextField(blank=True)),
                ('tochiMenseki', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('tatemonoMensekiStr', models.TextField(blank=True)),
                ('tatemonoMenseki', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('chikunengetsuStr', models.TextField(blank=True)),
                ('chikunengetsu', models.DateField(null=True)),
                ('kouzou', models.TextField(blank=True)),
                ('kaisuStr', models.TextField(blank=True, null=True)),
                ('kenpei', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('kenpeiStr', models.TextField(blank=True)),
                ('youseki', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('yousekiStr', models.TextField(blank=True)),
                ('youtoChiiki', models.TextField(blank=True)),
                ('setsudou', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('senyuMenseki', models.DecimalField(decimal_places=3, max_digits=10, null=True)),
                ('kaisuStr', models.TextField(blank=True, null=True)),
                ('chikunengetsuStr', models.TextField(blank=True)),
                ('chikunengetsu', models.DateField(null=True)),
