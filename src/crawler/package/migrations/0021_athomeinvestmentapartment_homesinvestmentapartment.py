# Generated by Django 5.2.16 on 2026-07-11 00:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('package', '0020_propertyevaluation_is_slack_notified'),
    ]

    operations = [
        migrations.CreateModel(
            name='AthomeInvestmentApartment',
            fields=[
                ...
                ('annualRent', models.IntegerField(blank=True, null=True)),
