# Generated by Django 5.2.16 on 2026-07-11 00:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('package', '0021_athomeinvestmentapartment_homesinvestmentapartment'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='duplicate_of',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='duplicates', to='package.propertyevaluation', verbose_name='名寄せ先親評価レコード'),
        ),
    ]
