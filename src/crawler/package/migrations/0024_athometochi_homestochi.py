...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('package', '0023_propertyevaluation_maintenance_comment_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tochiMenseki', models.DecimalField(blank=True, decimal_places=3, max_digits=10, null=True, verbose_name='土地面積（数値）')),
                ...
                ('maguchi', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='間口（数値）')),
                ('okuyukiStr', models.TextField(blank=True, null=True, verbose_name='奥行（文字列）')),
                ('okuyuki', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='奥行（数値）')),
                ('roadWidthStr', models.TextField(blank=True, null=True, verbose_name='前面道路幅員（文字列）')),
                ('roadWidth', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='前面道路幅員（数値）')),
