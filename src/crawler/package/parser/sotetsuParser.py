...
class SotetsuMansionParser(SotetsuParser, MansionParserBase):
    def _parsePriceStr(self, response, specs=None):
        return super()._parsePriceStr(response, specs)
    ...
    def _parsePropertyDetailPage(self, item, response: BeautifulSoup):
        ...
        # 築年月
        item.chikunengetsuStr = _first_spec(specs, "築年月", "築年月（竣工予定）", "完成時期")
...
class SotetsuKodateParser(SotetsuParser, KodateParserBase):
    def _parsePriceStr(self, response, specs=None):
        return super()._parsePriceStr(response, specs)
...
class SotetsuTochiParser(SotetsuParser, TochiParserBase):
    def _parsePriceStr(self, response, specs=None):
        return super()._parsePriceStr(response, specs)
